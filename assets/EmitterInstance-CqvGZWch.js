import { c as half, u as millisecondsToSeconds } from "./Constants-Boin98lu.js";
import { b as Vector, g as getRangeValue, r as calcPositionOrRandomFromSizeRanged, v as randomInRangeValue } from "./MathUtils-DBT3t4S6.js";
import { _ as PixelMode, f as itemFromSingleOrMultiple, m as safeDocument, r as deepExtend, u as isPointInside } from "./Utils-BJNts6wb.js";
import { r as AnimatableColor } from "./Stroke-mHi2yCfv.js";
import { d as Paint, n as EmitterSize, s as rangeColorToHsl, t as Emitter } from "./index--u1-ZVm4.js";
...
var EmitterInstance = class {
	...
	constructor(pluginManager, container, removeCallback, options, position) {
		...
		this.size = this.#size.mode === PixelMode.percent ? {
			width: this.#size.width / 100 * this.#container.canvas.size.width,
			height: this.#size.height / 100 * this.#container.canvas.size.height
		} : {
	...
	resize() {
		...
		this.#size = this.#calcSize();
		this.size = this.#size.mode === PixelMode.percent ? {
			width: this.#size.width / 100 * container.canvas.size.width,
			height: this.#size.height / 100 * container.canvas.size.height
		} : {
			width: this.#size.width,
			height: this.#size.height
		};
