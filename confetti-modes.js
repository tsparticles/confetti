...
templates['confetti-modes'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "    <div class=\"container\">\n        <div class=\"group\" data-name=\""
    ...
    + ((stack1 = lookupProperty(helpers,"each").call(alias1,(depth0 != null ? lookupProperty(depth0,"description") : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":15,"column":20},"end":{"line":19,"column":29}}})) != null ? stack1 : "")
    + "                </div>\n            </div>\n            <div class=\"editor\"></div>\n"
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,lookupProperty(helpers,"isCustom").call(alias1,(depth0 != null ? lookupProperty(depth0,"id") : depth0),{"name":"isCustom","hash":{},"data":data,"loc":{"start":{"line":23,"column":18},"end":{"line":23,"column":31}}}),{"name":"if","hash":{},"fn":container.program(4, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":23,"column":12},"end":{"line":31,"column":19}}})) != null ? stack1 : "")
    + "        </div>\n    </div>\n";
  ...
  return "                        <p class=\""
    + alias4(((helper = (helper = lookupProperty(helpers,"cssClass") || (depth0 != null ? lookupProperty(depth0,"cssClass") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"cssClass","hash":{},"data":data,"loc":{"start":{"line":16,"column":34},"end":{"line":16,"column":46}}}) : helper)))
    + "\">\n                            "
    + alias4(((helper = (helper = lookupProperty(helpers,"text") || (depth0 != null ? lookupProperty(depth0,"text") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"text","hash":{},"data":data,"loc":{"start":{"line":17,"column":28},"end":{"line":17,"column":36}}}) : helper)))
    + "\n                        </p>\n";
